...
export const levels: Level[] = [
    ...
    },
    {
        ...
        description: "在比特幣挖礦中，礦工需要找到一個 nonce 值，使得區塊標頭的 SHA-256 雜湊值符合難度目標。<br />假設當前難度要求雜湊值最後4位必須為0222，現在有以下區塊資料：<br />• 前一區塊雜湊：000abc123def<br />• 交易資料雜湊：xyz789uvw<br />• 時間戳：1609459200<br />• nonce：需要找出<br />將這些資料按順序串接並計算 SHA-256，找出使結果前4位為0222的最小 nonce 值(1000-2000）。<br />串接格式：{前一區塊雜湊}{交易資料雜湊}{時間戳}{nonce}",
