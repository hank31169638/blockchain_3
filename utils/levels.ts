...
export const levels: Level[] = [
    ...
    },
    {
        ...
        hint: "關鍵思考：當N=51時，每人淨收益=100/51-1≈0.96代幣（有利潤）。當N=99時，每人淨收益=100/99-1≈0.01代幣（微利）。當N=100時，每人淨收益=0（無利潤）。理性人會在有利潤時參與，但參與人數越多利潤越少。在競爭均衡下，會趨向於淨收益接近0的點。",
        inputType: "text",
        example: "MID67",
        status: "locked",
        answer: "HIGH99",
    ...
    },
    {
        ...
        hint: "將所有時間轉換為UTC，分析每個區塊的實際產生時間和依賴關係。考慮哪些區塊會形成有效鏈，哪些會被孤立。找出最長的有效鏈及其最後一個區塊。",
        inputType: "text",
        example: "CHAIN4L2",
        status: "locked",
        answer: "CHAIN3N1",
    ...
    },
    {
        ...
        hint: "計算每個提案的實際支持率。Alice提案：A30+SA15=45%，Bob提案：B25+SB9=34%。都未達到50%門檻。決定性群體是那些讓所有提案都無法通過的群體。",
        inputType: "text",
