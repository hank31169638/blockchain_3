...
export const levels: Level[] = [
    {
        ...
        hint: "思考上課說到雜湊函數的四個核心特性。用中文回答，空格分隔。",
        inputType: "text",
    ...
    },
    {
        ...
        description: "在比特幣挖礦中，礦工需要找到一個 nonce 值，使得區塊標頭的 SHA-256 雜湊值符合難度目標。<br />假設當前難度要求雜湊值最後4位必須為0222，現在有以下區塊資料：<br />• 前一區塊雜湊：000abc123def<br />• 交易資料雜湊：xyz789uvw<br />• 時間戳：1609459200<br />• nonce：需要找出<br />將這些資料按順序串接並計算 SHA-256，找出使結果前4位為0222的最小 nonce 值（1000-2000範圍）。<br />串接格式：{前一區塊雜湊}{交易資料雜湊}{時間戳}{nonce}",
        hint: "將資料按格式串接：000abc123defxyz7891609459200{nonce}，計算SHA-256直到前4位為0222。從nonce=0開始嘗試。",
        inputType: "text",
        example: "1903(nonce值)",
        status: "locked",
        answer: "1314",
    ...
    },
    {
        ...
        hint: "將所有時間轉換為UTC，分析每個區塊的實際產生時間和依賴關係。考慮哪些區塊會形成有效鏈，哪些會被孤立。",
        inputType: "text",
        example: "CHAIN4L2",
        status: "locked",
        answer: "CHAIN3N1",
